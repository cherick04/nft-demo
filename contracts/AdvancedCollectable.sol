...
contract AdvancedCollectable is ERC721, VRFConsumerBase {
    ...
    // Good practice to emit an event after updating a mapping
        ...
        override
    {
        ...
        _safeMint(owner, newTokenId); // msg.sender needs to be the caller of the collectable (owner)
        tokenCounter += 1;
    }

    function setTokenURI(uint256 tokenId, string memory tokenURI) public {
        // _isApprovedOrOwner and _msgSender() are imported from OpenZepplin
        require(
